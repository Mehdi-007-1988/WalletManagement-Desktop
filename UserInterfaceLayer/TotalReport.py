...
class totalReport:
    def formLoad(self):
        ...
        totalReportWalletValue = Label(totalReportFrame,fg='Green', font=('Calibri', 12, 'bold'), bg='#F3E5F5',
        ...
        totalReportIncomeValue = Label(totalReportFrame,font=('Calibri', 12, 'bold'), bg='#F3E5F5', fg='Blue',
        ...
        totalReportCostValue = Label(totalReportFrame,font=('Calibri', 12, 'bold'), bg='#F3E5F5',
