...
class about:
    def formLoad(self):
        ...
        # -------<< Versio Label >> :
        versionLabel = Label(aboutFrame, text=version, fg='Indigo', bg='#F3E5F5', font=('Calibri', 12, 'bold'))
        versionLabel.grid(row=0, column=0, padx=10, pady=5, sticky='w')
        # -------<< Date Label >> :
        dateLabel = Label(aboutFrame, text=date, fg='Indigo', bg='#F3E5F5', font=('Calibri', 12, 'bold'))
        dateLabel.grid(row=1, column=0, padx=10, pady=5, sticky='w')
        # -------<< Name Label >> :
        nameLabel = Label(aboutFrame, text=name, fg='Indigo', bg='#F3E5F5', font=('Calibri', 12, 'bold'))
